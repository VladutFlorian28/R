...
cat("Script rulat complet. Vezi fișierele generate: books_vs_age.png, books_vs_membership_years.png, real_vs_predicted.png, probability_scatter.png, predictions_regression.csv, predictions_classification.csv\n")
